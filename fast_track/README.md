...
- **The optional appendices** (classical → deep-learning → foundation-model forecasting, PyTorch, TabPFN/conformal prediction, vector-store & RAG/agent-framework surveys, and the pricing / A/B-testing / credit-risk / causal-uplift industry deep dives, and the DuckDB/Polars big-data tour), **Module 12 (DeepTab)**, **Module 16 (Business AI)** as a standalone lesson, and **Module 17 (Django)**.
