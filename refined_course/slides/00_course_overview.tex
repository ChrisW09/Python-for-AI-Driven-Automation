...
\begin{frame}{Seven modules, twenty-seven notebooks}
  \footnotesize
  \begin{tabular}{rll}
    \toprule
...
\begin{frame}{Now → open Notebook 0}
  \begin{center}
    {\Huge \textbf{00\_onboarding/00\_master\_onboarding.ipynb}}\\[12pt]
    {\large Read it. Run the environment check.}\\[6pt]
