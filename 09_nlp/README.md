# Module 9 — NLP: Text Analytics (Topic Modeling & Sentiment)
...
```
        ...
        ┌───────────────────────────┐                 ┌──────────────────────┐
        │ NB 35 — BERTopic           │                 │ NB 37 — Sentiment    │
...
```bash
pip install bertopic          # NB 35 — pulls sentence-transformers, umap-learn, hdbscan
pip install stream-topic      # NB 36 — AnFreTh/STREAM
pip install vaderSentiment    # NB 37 — lexicon sentiment
pip install transformers torch  # NB 37 — transformer sentiment pipelines
```
