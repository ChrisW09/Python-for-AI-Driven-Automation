% ============================================================
% Lecture deck — Module 14 / Notebook 44
...
\subtitle{Module 14 --- Business AI in Practice $\cdot$ Notebook 44}
...
\begin{frame}{Three-tier --- the workhorse for interactive AI features}
  ...
  \begin{itemize}
    ...
    \item \emph{You build exactly this} in \textbf{Notebook 28 (POC 2)}.
  \end{itemize}
\end{frame}
...
\end{lstlisting}
  ...
  \end{itemize}
  {\footnotesize You build this end-to-end in \textbf{Notebook 28 (POC 2)} --- Streamlit $+$ FastAPI $+$ SQLite.}
\end{frame}
...
\begin{frame}{How the course maps to these patterns}
  ...
  \begin{tabular}{ll}
    ...
    ML pipeline, deep-learning variant & NB 50--52 --- train / regularise / export (TorchScript) \\
    \bottomrule
  \end{tabular}
  \end{center}
  \vspace{4pt}
  {\footnotesize You \emph{build} the three-tier and ML-pipeline shapes in \textbf{Notebook 28}; the rest you meet as patterns here.}
\end{frame}
