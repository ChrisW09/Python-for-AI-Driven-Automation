% ============================================================
% Lecture deck — Module 14 / Notebook 46
...
\subtitle{Module 14 --- Business AI in Practice $\cdot$ Notebook 46}
...
\begin{frame}{A one-page readiness checklist}
  ...
  \begin{block}{Ten questions a technical lead uses to say ``no'' constructively}
    \begin{enumerate}
      ...
      \item \textbf{Pattern $\times$ stake} --- where on the 2$\times$2 from Notebook 43?
    ...
    \end{enumerate}
  \end{block}
  {\footnotesize Full detail, the RACI table, and the three cases end-to-end are in \textbf{Notebook 46}.}
\end{frame}
