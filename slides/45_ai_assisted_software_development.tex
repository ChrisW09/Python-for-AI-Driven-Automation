% ============================================================
% Lecture deck — Module 14 / Notebook 45
...
\subtitle{Module 14 --- Business AI in Practice $\cdot$ Notebook 45}
...
\begin{frame}{Three ways the assistant helps --- rising autonomy}
  ...
  \end{tikzpicture}
  \end{center}
  {\footnotesize The more the assistant does on its own, the more your review discipline matters (Module 8 --- agents, tools \& MCP --- builds on Agent mode).}
\end{frame}
...
\begin{frame}{When \emph{not} to use the AI assistant}
  ...
  \begin{itemize}
    ...
    \item \textbf{Companion notebook:} hands-on Git, PR, and review exercises are in \textbf{Notebook 45} --- recommended \emph{early} so the workflow pays off everywhere.
  \end{itemize}
\end{frame}
