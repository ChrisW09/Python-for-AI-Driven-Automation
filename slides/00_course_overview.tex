...
\begin{frame}{Seven modules, twenty-six notebooks}
  ...
  \begin{tabular}{rll}
    ...
    2 & Real-world I/O          & NB 7–8  — HTTP, SQL  \emph{(data validation reserved)} \\
    ...
    6 & Production              & NB 23–24 — packaging, scheduling  \emph{(config reserved)} \\
...
\begin{frame}{Plus two big capstones at the end}
  \begin{exampleblock}{Capstone A — AI Support-Bot Analytics (NB 26)}
  ...
  \end{exampleblock}
  \vspace{6pt}
  \begin{block}{Capstone B — AI Customer-Feedback Assistant (NB 27)}
