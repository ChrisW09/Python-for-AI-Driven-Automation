...
\begin{frame}{Nine modules, thirty-four notebooks}
  \footnotesize
  \begin{tabular}{rll}
    \toprule
...
\begin{frame}{When to pick which path}
  \begin{block}{Complete beginner}
    Never written code before. Take all nine modules in \textbf{spiral order} (see it work first, then the skills, then the builds). Time-budget: \textbf{about 90 hours} — the interactive estimator in \texttt{00b} computes yours.
  \end{block}
  \begin{exampleblock}{Analyst who knows Excel and SQL}
    Skim Module 1 (Python basics); Module 3's SQL will feel familiar. Focus on Modules 2 (data science), 4 (ML), 7 (capstone). Time-budget: \textbf{about 30 hours}.
  \end{exampleblock}
...
\begin{frame}{Ten weeks, self-paced}
  \begin{center}
...
\begin{frame}
  \begin{center}
    ...
    \large 34 notebooks await you.\\[20pt]
