...
\begin{frame}{Ten modules, thirty-eight notebooks}
  \footnotesize
  \begin{tabular}{rll}
    \toprule
    ...
    3 & Real-world I/O          & NB 12–13 — HTTP, SQL, Pydantic validation \\
    ...
    6 & Production              & NB 22–23 — packaging, scheduling, config \& secrets \\
    7 & Capstones               & NB 24–25 — analytics + AI assistant \\
    8 & Business AI             & NB 26–29 — strategy, architecture, BPM, governance \\
    9 & Building AI POCs        & NB 30–34 — LLM theory, Copilot, three POCs, RAG, agents \\
    10 & Industry applications   & NB 35–38 — churn value, fraud, segmentation, forecasting \\
    \bottomrule
  \end{tabular}
  \vspace{6pt}
...
\begin{frame}{When to pick which path}
  \begin{block}{Complete beginner}
    Never written code before. Take all nine modules in \textbf{spiral order} (see it work first, then the skills, then the builds). Time-budget: \textbf{about 105 hours} — the interactive estimator in \texttt{00b} computes yours.
  \end{block}
  \begin{exampleblock}{Analyst who knows Excel and SQL}
    Skim Module 1 (Python basics); Module 3's SQL will feel familiar. Focus on Modules 2 (data science), 4 (ML), 10 (industry applications), 7 (capstone). Time-budget: \textbf{about 43 hours}.
  \end{exampleblock}
  \begin{block}{ML practitioner adding AI engineering}
    Skim Module 4. Focus on Modules 5 (AI), 6 (production), 9 (build the POCs), 7 (capstone). Time-budget: \textbf{about 25 hours}.
  \end{block}
\end{frame}

\begin{frame}{Eleven weeks, self-paced}
  \begin{center}
...
\begin{frame}
  \begin{center}
    ...
    \large 38 notebooks await you.\\[20pt]
