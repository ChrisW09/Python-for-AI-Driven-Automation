...
\begin{frame}{When to pick which path}
  ...
  \begin{exampleblock}{Analyst who knows Excel and SQL}
    Skim Module 1 (Python basics); Module 3's SQL will feel familiar. Focus on Modules 2 (data science), 4 (ML), 10 (industry applications), 7 (capstone). Time-budget: \textbf{about 40 hours}.
  \end{exampleblock}
