...
\begin{frame}{When \emph{not} to use the AI assistant}
  ...
  \begin{itemize}
    ...
    \item \textbf{Companion notebook:} hands-on Git, PR, and review exercises are in \textbf{Notebook 28} --- recommended \emph{early} so the workflow pays off everywhere.
  \end{itemize}
\end{frame}
