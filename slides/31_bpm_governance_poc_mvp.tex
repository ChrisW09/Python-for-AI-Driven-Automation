...
\begin{frame}{A one-page readiness checklist}
  ...
  \begin{block}{Ten questions a technical lead uses to say ``no'' constructively}
    \begin{enumerate}
      ...
      \item \textbf{Pattern $\times$ stake} --- where on the 2$\times$2 from Notebook 28?
    ...
    \end{enumerate}
  \end{block}
  {\footnotesize Full detail, the RACI table, and the three cases end-to-end are in \textbf{Notebook 31}.}
\end{frame}
