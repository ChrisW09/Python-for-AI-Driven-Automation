% ============================================================
% Lecture deck — Module 9 / Notebook 30
...
\subtitle{Module 9 --- Building AI POCs $\cdot$ Notebook 30}
...
\begin{frame}{Three levels of using an LLM}
  ...
  \begin{exampleblock}{Fine-tuning vs RAG}
    Fine-tuning changes \emph{behaviour / style}. \textbf{RAG} (NB 33) keeps the weights frozen and supplies \emph{fresh facts} --- don't fine-tune to add knowledge.
  \end{exampleblock}
\end{frame}
...
\begin{frame}{Two structural limitations}
  ...
  \begin{exampleblock}{Mitigations (built later in the course)}
    \textbf{RAG} (NB 33) grounds answers in evidence $\cdot$ \textbf{Tools} (NB 34) let it look things up $\cdot$ \textbf{Evaluation} (NB 21) measures how often it's wrong.
  \end{exampleblock}
\end{frame}
