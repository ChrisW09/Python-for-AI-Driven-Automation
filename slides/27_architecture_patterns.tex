...
\subtitle{Module 8 --- Business AI in Practice $\cdot$ Notebook 27}
...
\begin{frame}{Three-tier --- the workhorse for interactive AI features}
  ...
  \begin{itemize}
    ...
    \item \emph{You build exactly this} in \textbf{Notebook 32 (POC 2)}.
  \end{itemize}
\end{frame}
...
\end{lstlisting}
  ...
  \end{itemize}
  {\footnotesize You build this end-to-end in \textbf{Notebook 32 (POC 2)} --- Streamlit $+$ FastAPI $+$ SQLite.}
\end{frame}
...
\begin{frame}{How the course maps to these patterns}
  ...
  \begin{tabular}{ll}
    ...
    Scheduled single-tier           & NB 23 --- scheduling \& orchestration \\
    Three-tier with AI in the middle& NB 32 (POC 2) and NB 25 capstone \\
    ...
    ML pipeline                     & NB 14--17 $+$ NB 23 --- train / evaluate / serve \\
    \bottomrule
  \end{tabular}
  \end{center}
  \vspace{4pt}
  {\footnotesize You \emph{build} the three-tier and ML-pipeline shapes in \textbf{Notebook 32}; the rest you meet as patterns here.}
\end{frame}
