...
- `cd 12_cicd/example-app` — move into the directory that contains [`docker-compose.yml`](example-app/docker-compose.yml); Compose looks for that file in the current directory.
